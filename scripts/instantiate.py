...
compile_target = os.path.realpath(os.path.join(script_dir, "compile_servlet_model.py"))
...
os.symlink(compile_target, os.path.join(target_dir, "compile_servlet_model.py"))

...
public class AggressiveDispatchInlineTransformer implements ConditionalTransformer {
	...
	public AggressiveDispatchInlineTransformer(final JspUrlRouter router, final Map<Local, Set<String>> deferredResolution, final boolean quiet) {
		this.router = router;

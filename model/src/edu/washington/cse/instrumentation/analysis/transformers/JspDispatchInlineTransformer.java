...
public final class JspDispatchInlineTransformer implements ConditionalTransformer {
	...
	public boolean transformMethod(final SootMethod m) {
		...
		while(it.hasNext()) {
			...
			{
				final SootMethod syntheticMethod = new SootMethod("_jspInline" + (forwardCounter++), Collections.<Type>emptyList(), VoidType.v(), Modifier.PUBLIC,
